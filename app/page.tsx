...
export default async function Home() {
  ...
  return (
    <section className="flex flex-col gap-4 flex-grow py-3 md:py-4">
      
      <div className="flex flex-col gap-4 items-center justify-center min-h-svh">
        <div className="inline-block max-w-lg text-center justify-center mb-3">
          <h1 className={title()}>{myHero.title}</h1>
          <br />
        ...
        <div className="grid lg:grid-cols-1 md:grid-cols-1 gap-4 min-h-full justify-items-center">
          {/* 
          <Image
          ...
          */}
          <Image
            ...
            className="w-full lg:h-full md:w-auto"
          />
        </div>
      </div>
